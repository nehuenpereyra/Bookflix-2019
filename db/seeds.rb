...
if !Subscriber.exists?(email: "jeansoft@hotmail.com")
    Subscriber.create!(email: "jeansoft@hotmail.com", name: "jean", last_name: "soft", password: "jeansoft", card_number: "4536000123456789", expiration_date: "2019-11-28",card_key: "123")
end
if !Subscriber.exists?(email: "admin@admin.com")
    Subscriber.create!(email: "admin@admin.com", name: "admin", last_name: "admin", password: "admin123",card_number: "6666666666666666", expiration_date: "2019-11-28",card_key: "666")
end
...
Part.find_or_create_by(book_id:1,
    ...
    position:0,
    normal_release_date:"2019-11-28",
    premium_release_date:"2019-12-10")
