...
if !Subscriber.exists?(email: "admin@admin.com")
    Subscriber.create!(email: "admin@admin.com", name: "admin", last_name: "admin", password: "admin123",card_number: "6666666666666666", expiration_date: "2019-11-14",card_key: "666")
end
...
Part.find_or_create_by(book_id:1,
    ...
    position:0,
    normal_release_date:"2019-11-14",
    premium_release_date:"2019-11-21")

Part.find_or_create_by(book_id:1,
    url_document:"https://juancrazyheart.files.wordpress.com/2014/12/1-juego-de-tronos.pdf",
    position:1,
    normal_release_date:"2019-11-20",
    premium_release_date:"2019-11-25")

Part.find_or_create_by(book_id:1,
    url_document:"https://juancrazyheart.files.wordpress.com/2014/12/1-juego-de-tronos.pdf",
    position:2,
    normal_release_date:"2019-11-25",
    premium_release_date:"2019-11-26")
